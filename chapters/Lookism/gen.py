...
<title>Chapter {chapter_number} - Lookism</title>
...
<li><a href="../../chapters/Lookism/chapter{prev_chapter}.html">Prev</a></li>
<li><a href="../../chapters/Lookism/chapter{next_chapter}.html">Next</a></li>
<li><a href="../../chapters/Lookism.html"><i class="fas fa-bars"></i> Title</a></li>
...
<script>
        ...
        const baseUrl = 'https://official.lowee.us/manga/Lookism/';
...
<script>
    document.addEventListener("DOMContentLoaded", function () {{
        var chapterListPath = "../../chapters/Lookism.html";
